...
/*
 * This is a class for GUI experimentation
 */

namespace AlgorithmVisualizer.GUI
{
    public class GUIEntityImpl : IGUIEntity
    {
        ...
        public GUIEntityImpl(GraphicsInstance graphicsInstance, Color color, Size size, Point location)
        {
